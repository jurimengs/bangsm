<?php /* Smarty version Smarty-3.0.7, created on 2016-01-08 02:53:36
         compiled from "E:/wamp/www//yanqi/templates\sysadmin/product.html" */ ?>
<?php /*%%SmartyHeaderCode:11885568f24b0a75b21-25007593%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c04304ffaef5ae8b29f8337998b8e5e2a17299cc' => 
    array (
      0 => 'E:/wamp/www//yanqi/templates\\sysadmin/product.html',
      1 => 1452177713,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11885568f24b0a75b21-25007593',
  'function' => 
  array (
  ),
...
﹄ <?php echo $_smarty_tpl->getVariable('typeList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['name'];?>
            ...
            <tr id="piliang_img">
                <th>批量上传文件：</th>
                <td>
                    <input name="pziliao"  type="text" class="input" id="pziliao" style="width:400px;" />
                    <br />
                    <input id="pziliao_upload" type="file" name="Filedata" />
                    <ul class="imgbox" id="piliangxianshiz">
                    </ul>
                <td>
            </tr>
            <tr>
...
"/><span>建议上传 900*600左右以下图片，浏览效果较好!</span><br />
...
" height="38" style="margin-top:8px;" onclick="deleteimg(this)">
            ...
            <tr id="piliang_img">
                <th>批量上传文件：</th>
                <td>
                    <input name="pziliao" value="<?php echo $_smarty_tpl->getVariable('product')->value['pziliao'];?>
"  type="text" class="input" id="pziliao" style="width:400px;" />
                    <br />
                    <input id="pziliao_upload" type="file" name="Filedata" />
                    <ul class="imgbox" id="piliangxianshiz">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('#pziliao_upload').uploadify({
            ...
            'onComplete' :function(event,queueID,fileObj,response,data){
                $("#pziliao").val($("#pimage").val()+response+",");
                //$("#simage").val(response);
                //$("#spic").attr("src",'../'+response);
                //alert("s"+response+"s");
                $("#piliangxianshiz").append("<li onclick=\"javascript:if(confirm('确实要删除吗?'))deleteimg(this);\" style=\"line-height:20px;width:400px;over-flow:hidden;cursor:pointer \">"+response+"</li>");
                $("#btnSubmit").attr("disabled",false);
