<?php /* Smarty version Smarty-3.0.7, created on 2016-01-12 17:31:20
         compiled from "/var/www/virtual/bangmaisiw/home/wwwroot/wap/templates/sysadmin/course.html" */ ?>
<?php /*%%SmartyHeaderCode:6655661395694c7e8a57486-84192435%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc870ff169684c900f7c35c1b316a96c40a8c0d0' => 
    array (
      0 => '/var/www/virtual/bangmaisiw/home/wwwroot/wap/templates/sysadmin/course.html',
      1 => 1452591054,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6655661395694c7e8a57486-84192435',
  'function' => 
  array (
  ),
...
" <?php if ($_smarty_tpl->getVariable('productList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['color']==0){?>style="cursor: pointer;width:20px;"<?php }else{ ?>style="width:20px;background:red;cursor: pointer;"<?php }?>  onclick="updateColor(<?php echo $_smarty_tpl->getVariable('productList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['color'];?>
...
" class="edit">修改</a></td>
                <td><input style="color:#87A34D;cursor: pointer;" type="button" value="浏览" onclick="javascript:window.open('../Course-Details.php?id=<?php echo $_smarty_tpl->getVariable('productList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['id'];?>
');"></td>
            </tr>
            <?php endfor; else: ?>
            <tr>
