<?php /* Smarty version Smarty-3.0.7, created on 2016-01-13 10:12:09
         compiled from "/var/www/virtual/bangmaisiw/home/wwwroot/wap/templates/theme-list.html" */ ?>
<?php /*%%SmartyHeaderCode:3343520575695b27925d6d7-24125080%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fad43b1a2b1d35c48f1eed6d036d09163c99ceb9' => 
    array (
      0 => '/var/www/virtual/bangmaisiw/home/wwwroot/wap/templates/theme-list.html',
      1 => 1452651095,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3343520575695b27925d6d7-24125080',
  'function' => 
  array (
  ),
...
">
        <li>
            <div class="li-con">
                <div class="li-content" <?php if ($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['color']==1){?>style="color:red;"<?php }?>>
                  <?php echo mb_substr($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['title'],0,30,'utf-8');?>
...
">
        <li>
            <div class="li-con">
                <p <?php if ($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['color']==1){?>style="color:red;"<?php }?>><?php echo mb_substr($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['title'],0,60,'utf-8');?>
</p>
                <p class="date">
                    <?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['time'],"%Y/%m/%d");?>
