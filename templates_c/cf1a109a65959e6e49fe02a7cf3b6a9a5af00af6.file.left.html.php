<?php /* Smarty version Smarty-3.0.7, created on 2015-11-04 07:07:20
         compiled from "G:/wamp/www//jl/templates\public/left.html" */ ?>
<?php /*%%SmartyHeaderCode:37715639aea81fbd60-34176185%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf1a109a65959e6e49fe02a7cf3b6a9a5af00af6' => 
    array (
      0 => 'G:/wamp/www//jl/templates\\public/left.html',
      1 => 1446620821,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '37715639aea81fbd60-34176185',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('yemianid')->value=='conmpany'){?>
    <div class="cmain_leftarea">
        ...
        <ul>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='conm'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jl/conmpany/conmpany.php">公司简介</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='struct'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jl/conmpany/conmpany_struct.php">组织架构</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='history'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jl/conmpany/conmpany_history.php"> 发展历程</a></li>
...
?>
                    <li><a href="/jl/conmpany/conmpany_honor.php?whatid=<?php echo $_smarty_tpl->getVariable('left_conmpany')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
" style="font-size:12.5px;color:#000;"><?php echo $_smarty_tpl->getVariable('left_conmpany')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['name'];?>
            ...
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='porfit'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jl/conmpany/conmpany_profit.php">社会公益</a></li>
        </ul>
    </div>
 ...
 <?php }elseif($_smarty_tpl->getVariable('yemianid')->value=='culture'){?>   
     <div class="cmain_leftarea">
        ...
        <ul>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='linian'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jl/culture/culture.php">经营理念</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='nk'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jl/culture/culture_nk.php">企业内刊</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='tu'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jl/culture/culture_tu.php"> 图片专栏</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='video'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span> <a href="/jl/culture/culture_video.php">视频中心</a></li>
        </ul>
    </div>
...
?>
                    <li><a href="/jl/building/Building.php?whatid=<?php echo $_smarty_tpl->getVariable('left_building')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['sleft_building'][$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['parent_id'];?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['i']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['i']['total']);
?>
                    <li><a href="/jl/business/business-list.php?whatid=<?php echo $_smarty_tpl->getVariable('left_zhuying')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['parent_id'];?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['i']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['i']['total']);
?>
                    <li><a href="/jl/business/stretch.php?whatid=<?php echo $_smarty_tpl->getVariable('left_yanshen')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['parent_id'];?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['i']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['i']['total']);
?>
                    <li><a href="/jl/safety/safety.php?whatid=<?php echo $_smarty_tpl->getVariable('sleft_bai')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['parent_id'];?>
...
" style="font-size:12px;color:#000;"><?php echo $_smarty_tpl->getVariable('sleft_bai')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['name'];?>
     	  ...
     	  <li <?php if ($_smarty_tpl->getVariable('whatid')->value=="2"){?>class="cmain_leftarea_icon tehh"<?php }else{ ?>class="tehh"<?php }?>><span></span><a href="/jl/safety/safety-zhi.php?whatid=2"><?php echo $_smarty_tpl->getVariable('left_zhi')->value['name'];?>
</a></li>
        </ul>
    </div>
