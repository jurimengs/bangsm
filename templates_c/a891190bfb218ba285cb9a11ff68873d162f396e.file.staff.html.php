<?php /* Smarty version Smarty-3.0.7, created on 2015-10-29 02:27:56
         compiled from "G:/wamp/www//jl/templates\staff.html" */ ?>
<?php /*%%SmartyHeaderCode:44225631842cd0ebe3-94878957%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a891190bfb218ba285cb9a11ff68873d162f396e' => 
    array (
      0 => 'G:/wamp/www//jl/templates\\staff.html',
      1 => 1446085675,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '44225631842cd0ebe3-94878957',
  'function' => 
  array (
  ),
...
?>
                        <a href="/jl/staff/staff-xq.php?whatid=<?php echo $_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['type_id'];?>
&whattid=<?php echo $_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
">
                            <li>
                                <img src="../images/staff/staff1.png">
                                <h4><?php echo $_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['title'];?>
</h4>
                                <p>
                                <?php echo mb_substr($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['contents'],0,100,'utf-8');?>
<?php if (utf8_strlen($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['contents'])>100){?>...<?php }?>
                                  </p>
                            </li>
                            </a>
                         <?php endfor; endif; ?>   
