<?php /* Smarty version Smarty-3.0.7, created on 2015-10-26 09:09:53
         compiled from "G:/wamp/www//kener/templates\sysadmin/aboutus.html" */ ?>
<?php /*%%SmartyHeaderCode:9404562dede17f7219-37407532%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '026c0ef12d54aeaf8148f5a85340e5cc64dc988c' => 
    array (
      0 => 'G:/wamp/www//kener/templates\\sysadmin/aboutus.html',
      1 => 1435269900,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9404562dede17f7219-37407532',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_date_format')) include 'G:\wamp\www\kener\smarty\plugins\modifier.date_format.php';
...
" id="sort" maxlength="5" style="width:50px;" onKeyUp="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
    ...
    <tr <?php if ($_smarty_tpl->getVariable('product')->value['type_id']!=8){?>style="display:none;"<?php }?>>
        <th>招聘人数：</th>
        <td><input name="num" type="text" class="input" value="<?php echo $_smarty_tpl->getVariable('product')->value['num'];?>
" id="num" maxlength="5" style="width:50px;" onKeyUp="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')"/></td>
    </tr>
<tr>
    <th>上传文章图片：</th>
    <td>
