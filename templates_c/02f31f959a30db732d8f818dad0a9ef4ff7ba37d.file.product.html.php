<?php /* Smarty version Smarty-3.0.7, created on 2015-10-26 09:09:56
         compiled from "G:/wamp/www//kener/templates\sysadmin/product.html" */ ?>
<?php /*%%SmartyHeaderCode:16282562dede49d04f6-12215843%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '02f31f959a30db732d8f818dad0a9ef4ff7ba37d' => 
    array (
      0 => 'G:/wamp/www//kener/templates\\sysadmin/product.html',
      1 => 1445839363,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16282562dede49d04f6-12215843',
  'function' => 
  array (
  ),
...
" /> 
    ...
    <tr  style="display:none;">
        <th>英文名称：<font class="red">*</font></th>
        <td>
            <input name="entitle" maxlength="150" type="text" class="input" id="entitle" style="width:400px;" value="<?php echo $_smarty_tpl->getVariable('product')->value['entitle'];?>
"/>
        </td>
    </tr>
<tr style="display:none;">
...
" /> <br />
    ...
    <tr id="piliang_img">
        <th>批量上传文件：</th>
        <td>
            <input name="pimage" value="<?php echo $_smarty_tpl->getVariable('product')->value['pziliao'];?>
"  type="text" class="input" id="pimage" style="width:400px;" />
            <br />
            <input id="pimage_upload" type="file" name="Filedata" />
            <ul class="imgbox" id="piliangxianshi">
