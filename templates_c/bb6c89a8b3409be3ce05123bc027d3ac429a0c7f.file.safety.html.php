<?php /* Smarty version Smarty-3.0.7, created on 2015-11-24 15:42:21
         compiled from "/var/www/virtual/jialongwy/home/wwwroot/templates/safety.html" */ ?>
<?php /*%%SmartyHeaderCode:1754800601565414dd27ef89-56815040%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb6c89a8b3409be3ce05123bc027d3ac429a0c7f' => 
    array (
      0 => '/var/www/virtual/jialongwy/home/wwwroot/templates/safety.html',
      1 => 1448350927,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1754800601565414dd27ef89-56815040',
  'function' => 
  array (
  ),
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('top_t')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                                <div>
                                        ...
                                        <img src="../<?php echo $_smarty_tpl->getVariable('top_t')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['yuliu2'];?>
" style="width:334px;height:234px;">

                                    <div class="bktop_word">
                                        <h2><?php echo $_smarty_tpl->getVariable('top_t')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['title'];?>
<span></span></h2>

                                        <?php echo $_smarty_tpl->getVariable('top_t')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['contents'];?>
...
">
                                        <div class="img">
                                            <p><?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['time'],"%m/%d");?>
</p>
                                            <p class="p1"><?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('list')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['time'],"%Y");?>
</p>
                                        </div>
...
<script>
    $(".safety_bktop").slide({ titCell:".safety_bktop_index" , mainCell:".safetopchange" , effect:"fold", autoPlay:true, delayTime:700 , autoPage:true });
</script>
