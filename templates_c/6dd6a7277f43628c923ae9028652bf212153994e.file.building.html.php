<?php /* Smarty version Smarty-3.0.7, created on 2015-11-04 09:15:47
         compiled from "G:/wamp/www//jl/templates\building.html" */ ?>
<?php /*%%SmartyHeaderCode:278955639ccc32986c2-33212347%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6dd6a7277f43628c923ae9028652bf212153994e' => 
    array (
      0 => 'G:/wamp/www//jl/templates\\building.html',
      1 => 1446628545,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '278955639ccc32986c2-33212347',
  'function' => 
  array (
  ),
            ...
            <div class="new_change">
                <div class="newlist_t">
                    <div class="building_list">
                        <ul>
                            <li class="building_list_1"><span class="building_date">2015/09/06</span>

                                <div class="building_list_word">
                                <?php unset($_smarty_tpl->tpl_vars['smarty']->value['section']['i']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['name'] = 'i';
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('top')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                                <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['i']['first']=='true'){?>
                                    <img src="../<?php echo $_smarty_tpl->getVariable('top')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['image'];?>
">
                                    <h2><a href="/building/building_xq.php?whatid=<?php echo $_smarty_tpl->getVariable('top')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['type_id'];?>
&whattid=<?php echo $_smarty_tpl->getVariable('top')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
" style="color: #BE980D;"><?php echo $_smarty_tpl->getVariable('top')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['title'];?>
</a></h2>
                                    <p><?php echo mb_substr($_smarty_tpl->getVariable('top')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['contents'],0,90,'utf-8');?>
<?php if (utf8_strlen($_smarty_tpl->getVariable('top')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['contents'])>90){?>...<?php }?></p>
                               <?php }?>
                                <?php endfor; endif; ?>
                                </div>
                            </li>
