<?php /* Smarty version Smarty-3.0.7, created on 2015-11-05 09:56:45
         compiled from "/var/www/virtual/jialongwy/home/wwwroot/templates/sysadmin/conmpany_type.html" */ ?>
<?php /*%%SmartyHeaderCode:486436296563ab75ddc13c5-86623155%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e23030c08cc2bd951786ad1a259c57099c21fb50' => 
    array (
      0 => '/var/www/virtual/jialongwy/home/wwwroot/templates/sysadmin/conmpany_type.html',
      1 => 1446630100,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '486436296563ab75ddc13c5-86623155',
  'function' => 
  array (
  ),
...
" width="9" height="9" border="0" onclick="rowClicked(this)" /> 
      <a href="conmpany.php?type_id=<?php echo $_smarty_tpl->getVariable('typeList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['id'];?>
...
" class="edit">修改</a>
      <?php if ($_smarty_tpl->getVariable('typeList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['parent_id']=='a'){?><a href="?action=delete&id=<?php echo $_smarty_tpl->getVariable('typeList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['id'];?>
" onclick="return confirm('确定删除吗？')"  class="delete">删除</a><?php }?>
      </td> 
    </tr> 
    <?php endfor; else: ?>
    <tr><td colspan="4"><div class="notext">没有相关信息</div></td></tr>
    <?php endif; ?>
    </table>
<div class="desc">*</div> 
</div>
