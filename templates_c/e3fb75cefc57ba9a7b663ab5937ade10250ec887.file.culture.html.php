<?php /* Smarty version Smarty-3.0.7, created on 2015-12-08 08:52:39
         compiled from "E:/wamp/www//jlwy/templates\sysadmin/culture.html" */ ?>
<?php /*%%SmartyHeaderCode:82456669a57480930-99459258%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3fb75cefc57ba9a7b663ab5937ade10250ec887' => 
    array (
      0 => 'E:/wamp/www//jlwy/templates\\sysadmin/culture.html',
      1 => 1449564757,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '82456669a57480930-99459258',
  'function' => 
  array (
  ),
...
>','#ffffff', 120)" onmouseout="hideddrivetip()" /></td>
      ...
      <td><?php if ($_smarty_tpl->getVariable('productList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['tuijian']==1){?>已推荐<?php }elseif($_smarty_tpl->getVariable('productList')->value[$_smarty_tpl->getVariable('smarty')->value['section']['list']['index']]['tuijian']==2){?>已推荐<?php }else{ ?>未推荐<?php }?></td>
...
<tr id="small_img" >
    ...
    <tr class="piliang_img">
        <th>批量上传图片：</th>
        <td><input name="pimage"   type="text" class="input" id="pimage" style="width:400px;" /><span>建议上传 900*600左右以下图片增加浏览效果。</span><br />
    ...
    <tr id="ziliaotr"  class="trziliao">
        ...
        <td>
            ...
            <input id="ziliao_upload2" type="file" name="Filedata" />
        </td>
    </tr>
    <tr id="pdftr"  class="pdftr">
        <th>上传PDF：</th>
        <td>
            <input name="pdf" maxlength="100" type="text" class="input" id="pdf" style="width:400px;" /> <br />
            <input id="pdf_upload2" type="file" name="Filedata" />
        </td>
    </tr>
<tr>
    <th>文章关键字：</th>
...
"<?php }else{ ?>src="images/empty.gif"<?php }?> height="38" id="spic" style="margin-top:8px;" /></span>
    ...
    <tr class="piliang_img">
        <th>批量上传图片：</th>
        <td>
            <input name="pimage"   type="text" class="input" id="pimage" style="width:400px;" value="<?php echo $_smarty_tpl->getVariable('product')->value['pimage'];?>
"/><br />
            <input id="pimage_upload" type="file" name="Filedata" />
            <span class="imgbox" id="piliangxianshi">
                <?php $_smarty_tpl->tpl_vars['gd'] = new Smarty_variable(explode(',',$_smarty_tpl->getVariable('product')->value['pimage']), null, null);?>
...
?>
            <img src="../<?php echo $_smarty_tpl->getVariable('gd')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']];?>
" height="38" style="margin-top:8px;" onclick="deleteimg(this)">
                <?php endfor; endif; ?>
            </span><td>
    </tr>
<tr class="trziliao">
...
" /> <br />
    ...
    <tr id="pdftr"  class="pdftr">
        <th>上传PDF：</th>
        <td>
            <input name="pdf" maxlength="100" type="text" class="input" id="pdf" style="width:400px;"value="<?php echo $_smarty_tpl->getVariable('product')->value['pdf'];?>
" /> <br />
            <input id="pdf_upload2" type="file" name="Filedata" />
        </td>
    </tr>
...
KindEditor.ready(function(K) {
    ...
    $('#ziliao_upload2').uploadify({
		  ...
		  'fileExt'     : '*.flv; *.swf; *.mp4;',
		  'fileDesc'    : 'Select Files *.flv; *.swf; *.mp4;',
		  'onCancel'    : function(event,ID,fileObj,data) {
    		  $("#btnSubmit").attr("disabled",false);
  	  },
		  'onSelect':function(event,ID,fileObj) {
...
function gaibianfenlei(obj)
{
	if($(obj).val()==4)
	{
        ...
        $(".trziliao").css("display","");   //资料属性
         $(".pdftr").css("display","none");
        $(".piliang_img").css("display","none");
    }
	else if($(obj).val()==2)
	{
        $(".trdan").css("display","");
