<?php /* Smarty version Smarty-3.0.7, created on 2015-12-08 03:57:15
         compiled from "E:/wamp/www//jlwy/templates\public/left.html" */ ?>
<?php /*%%SmartyHeaderCode:265755666551b611206-01378002%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de1756267d41a041411258af71b97bd0a069ba56' => 
    array (
      0 => 'E:/wamp/www//jlwy/templates\\public/left.html',
      1 => 1449547034,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '265755666551b611206-01378002',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('yemianid')->value=='conmpany'){?>
    <div class="cmain_leftarea">
        ...
        <ul>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='conm'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jlwy/conmpany/conmpany.php">公司简介</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='struct'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jlwy/conmpany/conmpany_struct.php">组织架构</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='history'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jlwy/conmpany/conmpany_history.php"> 发展历程</a></li>
...
" style="font-size:12.5px;color:#000;"><?php echo $_smarty_tpl->getVariable('left_conmpany')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['name'];?>
            ...
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='porfit'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jlwy/conmpany/conmpany_profit.php">社会公益</a></li>
        </ul>
    </div>
 ...
 <?php }elseif($_smarty_tpl->getVariable('yemianid')->value=='culture'){?>   
     <div class="cmain_leftarea">
        ...
        <ul>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='linian'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jlwy/culture/culture.php">经营理念</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='nk'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jlwy/culture/culture_nk.php">企业内刊</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='tu'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span><a href="/jlwy/culture/culture_tu.php"> 图片专栏</a></li>
            <li <?php if ($_smarty_tpl->getVariable('yemianid2')->value=='video'){?>class="cmain_leftarea_icon"<?php }else{ ?><?php }?>><span></span> <a href="/jlwy/culture/culture_video.php">视频中心</a></li>
        </ul>
    </div>
...
?>
                    ...
                    <a <?php if ($_smarty_tpl->getVariable('left_building')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['sleft_building'][$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['id']=="5"||$_smarty_tpl->getVariable('left_building')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['sleft_building'][$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['id']=="9"||$_smarty_tpl->getVariable('left_building')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['sleft_building'][$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['id']=="12"){?>
	                     href="/jlwy/building/building-cont.php?whatid=<?php echo $_smarty_tpl->getVariable('left_building')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['sleft_building'][$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['parent_id'];?>
...
" 
	                    <?php }else{ ?>
	                    href="/jlwy/building/building.php?whatid=<?php echo $_smarty_tpl->getVariable('left_building')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['sleft_building'][$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['parent_id'];?>
&parent_id=<?php echo $_smarty_tpl->getVariable('left_building')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['sleft_building'][$_smarty_tpl->getVariable('smarty')->value['section']['j']['index']]['id'];?>
" 
	                    <?php }?>
...
<?php }elseif($_smarty_tpl->getVariable('yemianid')->value=="safety"){?>  
       <div class="cmain_leftarea">
        ...
        <ul>
 				<li <?php if ($_smarty_tpl->getVariable('whatid')->value=="2"){?>class="cmain_leftarea_icon tehh"<?php }else{ ?>class="tehh"<?php }?>><span></span><a href="/jlwy/safety/safety-zhi.php?whatid=2"><?php echo $_smarty_tpl->getVariable('left_zhi')->value['name'];?>
</a></li>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['i']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['i']['total']);
?>
        <li><span></span><a href="/jlwy/contact/contact.php?whatid=<?php echo $_smarty_tpl->getVariable('top_contact')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
"><?php echo $_smarty_tpl->getVariable('top_contact')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['name'];?>
</a></li>
        <?php endfor; endif; ?>
